          ...
          <TabsContent value="resident">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Sign in as a resident to manage your properties and payments</CardDescription>
              </CardHeader>
          ...
          <TabsContent value="admin">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Sign in as an administrator to manage the community</CardDescription>
              </CardHeader>
              <form onSubmit={handleSubmit}>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
