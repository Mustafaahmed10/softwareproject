...
export async function createProperty(data: Omit<Property, "property_id" | "created_at">): Promise<mysql.ResultSetHeader> {
...
export async function createParkingBooking(data: Omit<Parking, "parking_id" | "created_at">): Promise<mysql.ResultSetHeader> {
...
export async function createFacilityBooking(data: Omit<Facility, "facility_id" | "created_at">): Promise<mysql.ResultSetHeader> {
...
export async function deleteRecord(table: string, idField: string, id: number): Promise<mysql.ResultSetHeader> {
